...
Route::prefix('v1')->group(function(){
    ...
    Route::get('getServerDate', 'ApiAuthController@getServerDate');
    Route::group(['middleware' => 'auth:api'], function(){
        ...
        Route::post('getPacket','PacketAuctionController@getPacket');
        Route::post('buyPacket','PacketAuctionController@buyPacket');
        Route::post('setPacketWinner','PacketAuctionController@setPacketWinner');
        Route::post('setSell','PacketAuctionController@setSell');
        Route::post('updateSell','PacketAuctionController@updateSell');
    });
   });
